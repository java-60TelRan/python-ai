...
### Notes
1. Creating DataFrame example with test result: df = pd.DataFrame({"Company":['Toyota','Toyota','Hundai', 'Hunday', 'Hunday' ], "Model": ['Camry', 'Corolla', 'i10', 'Elantra', 'Kona']}); dfConverted = convertX(df, mapper={'Company': {'Toyota': 0, 'Hundai': 1}, 'Model': {'Camry': 0, 'Corolla': 1, 'i10': 2, 'Elantra':3, 'Kona':4}}); dfConverter.to_dict(orient="list") will be {"Company":[0,0,1,1,1], "Model": [0, 1, 2, 3, 4]}<br>
